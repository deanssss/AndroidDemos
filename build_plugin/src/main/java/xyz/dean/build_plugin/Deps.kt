...
object Deps {
    @JvmStatic fun kotlinLibrary(version: String): String = "org.jetbrains.kotlin:kotlin-stdlib-jdk7:$version"
    @JvmStatic fun kotlinReflectLibrary(version: String) = "org.jetbrains.kotlin:kotlin-reflect:$version"
